...
class DMINTLogAnalyzer:
    def __init__(self, log_file=None):
        ...
        # Args:
        #     log_file: 训练日志文件路径，如果为None则自动查找"C:\Users\Administrator\Desktop\AINEW\0106\seventeen_training_log_20260106_200429.txt"
        # """
        if log_file is None:
            # 自动查找可能的日志文件
...
def main():
    ...
    # 指定您的日志文件路径
    log_file = "logs\fifteen_training_log_20260102_184807.txt"
